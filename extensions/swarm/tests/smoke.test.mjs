...
if (missingCommands.length) { console.error("MISSING commands:", missingCommands); process.exit(1); }
if (typeof mod.isDeliveryFailureRetryable !== "function") { console.error("MISSING named export:", "isDeliveryFailureRetryable"); process.exit(1); }
