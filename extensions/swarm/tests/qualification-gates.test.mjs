...
await call("swarm_create_task", { taskId: "qualification-coder", title: "Coder must wait", goal: "Custom implementer role is gated", qualificationMode: "human-discuss", start: "build", nodes: { build: { role: "coder", terminal: true } }, edges: [] });
await expectError("custom coder role is blocked before confirmation", () => call("swarm_assign_task", { taskId: "qualification-coder", nodeId: "build", agentId: "implementer-q" }), "QUALIFICATION_NOT_READY");
