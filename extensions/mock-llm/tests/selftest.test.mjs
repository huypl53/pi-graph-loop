...
assert.equal(registered.config.models.length, 87, "expected 87 scenario models");
assert.deepEqual(
	...
	[
		...
		"r28-goal-stale-order-prevention",
		"reconcile-offset",
...
assert.equal((await listFixtureDiscovery()).length, 87);
